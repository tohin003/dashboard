...
if(isset($_POST['submit'])){
    ...
    // {
        $query="INSERT INTO `contact`(`name`, `email`, `phno`, `designation`) VALUES ('$name','$email','$phno','$desg')";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" name="phno" placeholder="Phone Number">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Designation</label>
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" name="desg" placeholder="Designation">
                      </div>
