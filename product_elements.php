                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Pricer">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Discount</label>
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="Discount">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Final Price</label>
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="Final Price">
                      </div>
